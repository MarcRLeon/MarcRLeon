...
- **Bowling League Management ERP**: Together with [@polnie](https://github.com/PolNie), we developed a simple [Bowling League Management ERP](https://github.com/MarcRLeon/ERP-Bowling-League-Management) using Java and Spring Boot. This system provides a simple and efficient solution for managing bowling leagues, facilitating tasks such as player registration, match tracking, and team management.
